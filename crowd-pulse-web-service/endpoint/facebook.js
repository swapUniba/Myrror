...
const API_USER_POSTS = 'https://graph.facebook.com/v9.0/me/feed?fields=id,message,full_picture,created_time,story,shares,to{id,name},place{name,location{latitude,longitude}}';
                ...
                request.get({url: API_USER_POSTS, qs: params, json: true}, function (err, response, posts) {
                    ...
                    posts.data.forEach(function (post) {
                        ...
                        if (post.place) {
                            ...
                            location_latitude = post.place.location.latitude;
