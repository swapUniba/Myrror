...
const API_STATS_MEDICALVISIT_TABLE_DATA_SOURCE = 'api/stats/medicalVisit_table_data/source';
...
export class StatsService {
  ...
  getMedicalVisitTypeDataTelegramTable(filter?: {dateFrom?: Date, dateTo?: Date}): Promise<any> {
    ...
    return this.http.get(`${this.url}${API_STATS_MEDICALVISIT_TABLE_DATA_SOURCE}${params}`).toPromise();
  }
